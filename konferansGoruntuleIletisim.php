...
echo "<a href='index.php?sayfa=konferansGoruntule&kGiris=$konferansId' class='iptalButonu2'>Geri</a>";
...
if (@$session->_read($_SESSION["girisKullaniciId"]) == 1 && @$session->_read3($_SESSION["girisKullaniciId"]) == NULL) {
    ...
    if ($sorgu->rowCount() > 0) {
        while ($rowKonferans = $sorgu->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<div class='konferansGoruntule'>" . $rowKonferans['konferansIletisim'] . "</div><br/><br/>";
        }
    }
